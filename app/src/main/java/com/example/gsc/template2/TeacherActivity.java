...
public class TeacherActivity extends AppCompatActivity
 ...
 public   FloatingActionButton fab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().beginTransaction().replace(R.id.content_teacher, new MainTeacher()).setCustomAnimations(android.R.animator.fade_in, android.R.animator.fade_out).commit();
...
new Savetoken().execute();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_tprofile) {
            ...
            getFragmentManager().beginTransaction().replace(R.id.content_teacher,new UpdateProfileTeacher()).addToBackStack(null).commit();

        } else if (id == R.id.nav_treq) {
            getFragmentManager().beginTransaction().replace(R.id.content_teacher,new TeacherRequestTab()).addToBackStack(null).commit();


        }  else if (id == R.id.nav_share) {
            getFragmentManager().beginTransaction().replace(R.id.content_teacher,new FragmentDisucssions()).addToBackStack(null).commit();
